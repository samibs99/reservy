    ...
    <main className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-600 mb-6">Vous n'avez pas encore de compte ? <Link href="/pro/register" className="text-purple-600">Commencer</Link></p>
          ...
          <form className="space-y-4">
            ...
            <button type="submit" className="w-full bg-gray-900 text-white py-2 rounded">Connexion</button>
          </form>

          <p className="mt-4 text-sm text-center text-gray-600">Besoin d'aide ? <a href="#" className="text-purple-600">Contact</a></p>
        </div>
      </div>
    </main>
  );
